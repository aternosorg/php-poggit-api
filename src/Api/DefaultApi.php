...
class DefaultApi
{
    ...
    {
        list($response) = $this->getResourceWithHttpInfo($resource, $access_token, $authorization, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->getResourceRequest($resource, $access_token, $authorization, $contentType);
    ...
    {
        return $this->getResourceAsyncWithHttpInfo($resource, $access_token, $authorization, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
