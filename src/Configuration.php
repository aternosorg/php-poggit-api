...
class Configuration
{
     ...
     * @var string
     */
    protected string $host = 'https://poggit.pmmp.io';
     ...
     * @var string
     */
    protected string $userAgent = 'OpenAPI-Generator/0.2.0/PHP';
    ...
    {
        $report  = 'PHP SDK (Aternos\PoggitApi) Debug Report:' . PHP_EOL;
